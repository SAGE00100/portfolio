        ...
        >
          <div className="font-bold space-y-3">
            ...
            <h1 className="text-4xl lg:text-6xl sm:text-5xl">
              I&apos;m <span className="text-secondary">Prashant Dangwal</span>
            </h1>
          ...
          <div className="flex justify-start items-center mt-8 mb-12">
            <a
              ...
              download="prashant's_resume.pdf"
              aria-label="Download Prashant's Fullstack Developer Resume"
          ...
          <div className="social-media-links">
            <ul className="flex gap-6">
              <li>
                <a
                  href="https://linkedin.com/in/sage-pd?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                  target="_blank"
                ...
                >
                  <Image
                    ...
                    src="/linkedin.svg"
                    alt="prashant's-linkedin"
                  />
                </a>
              </li>
              <li>
                <a
                  href="https://github.com/SAGE00100"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <Image
